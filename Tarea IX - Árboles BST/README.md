...
Este programa permite trabajar con un Árbol Binario de Búsqueda, también conocido como BST.

Un BST es una estructura de datos donde cada nodo puede tener un hijo izquierdo y un hijo derecho.
